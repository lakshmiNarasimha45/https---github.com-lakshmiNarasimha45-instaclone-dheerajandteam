...
export default function Login() {
    ...
    return (
    <div style={{paddingTop:"100px",paddingLeft:"30%",textAlign:"center",backgroundColor:'white',paddingBottom:"50px"}}>
        <Box
      sx={{
        width: 300,
        height: 300,
    ...
    >
      ...
      <p style={{color:"black"}}>Dont have an account <Link style={{cursor:"pointer"}} onClick={change}>Signup</Link></p>
      </Stack>
      </Box>
    </div>
